...
export default function BlogDetails() {
  return (
    <div>
      Lorem ipsum dolor sit, amet consectetur adipisicing elit. Facere iure iste
      adipisci atque eveniet a modi exercitationem possimus, unde, nobis, totam
      molestias eius sequi sit tempora porro odio culpa dolorem!
    </div>
  );
}
